...
def load_chat_history():
    ...
    try:
        ...
        # ফায়ারবেস ইনডেক্সিং তৈরি না থাকলে ক্র্যাশ এড়াতে সাধারণ স্ট্রিম ব্যাকআপ
        try:
...
subject = st.sidebar.selectbox("📚 বিষয় নির্বাচন করো", [
    ...
    "Sociology 1st Paper", "Sociology 2nd Paper", "Islamic History & Culture", "Logic", "Social Work", "Geography",
    # COMPULSORY & OPTIONAL
    "Bangla 1st Paper", "Bangla 2nd Paper", "English 1st Paper", "English 2nd Paper", "ICT",
    "Agriculture", "Statistics", "Psychology", "Home Science", "Islamic Studies"
])
...
def call_gemini(api_key, text_prompt, image_pil=None):
    try:
        # নতুন লাইব্রেরি ভ্যালিডেশন অনুযায়ী সঠিক ক্লায়েন্ট কল
        ...
        error_text = str(e)
        # জেমিনির কোটা শেষ হলে স্বয়ংক্রিয়ভাবে Llama3 ব্যাকআপ চালু হবে
...
if st.sidebar.button("📝 Generate MCQ", use_container_width=True):
    mcq_prompt = f"তুমি একজন বিশেষজ্ঞ শিক্ষক। {subject} বিষয়ের HSC স্তরের ১০টি গুরুত্বপূর্ণ MCQ প্রশ্ন তৈরি করো এবং নিচে তার সঠিক উত্তর ব্যাখ্যাসহ সাবলীল বাংলায় দাও।"
...
# =========================================
prompt = st.chat_input("प्रश्न লেখো অথবা PDF / ছবি আপলোড করো...", accept_file=True, file_type=["jpg", "jpeg", "png", "pdf"])
...
if prompt:
    ...
    # UI-তে ইউজারের মেসেজ সুন্দরভাবে প্রদর্শন করা
    ...
    # এআই প্রম্পট ইঞ্জিনিয়ারিং (ব্যাকগ্রাউন্ডে যাবে)
    ...
    # ডেটাবেজে শুধুমাত্র অরিজিনাল ক্লিন মেসেজ সেভ হবে (সিস্টেম ইনস্ট্রাকশন বাদে)
    ...
    with st.chat_message("assistant"):
        ...
        # হিস্ট্রি ও ক্লাউড ডেটাবেজে রেসপন্স সেভ
