...
model_choice = st.sidebar.radio("তোমার পছন্দের AI মডেলটি বেছে নাও:", ["Gemini 1.5 Pro", "Llama3 (via Groq)"])
...
if user_input := st.chat_input("এখানে তোমার প্রশ্নটি লেখো... (যেমন: English Right form of verbs এর নিয়ম কী?)"):
