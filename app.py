...
st.subheader("Llama3 এবং Gemini-র সমন্বয়ে HSC প্রস্তুতি Created by ALhaz")
...
model_choice = st.sidebar.radio("তোমার পছন্দের AI মডেলটি বেছে নাও:", ["Gemini 1.5 Flash", "Llama3 (via Groq)"])
